...
// --------------------------------------------------------------------------------------------------------------
  ...
  private Boolean isNullFile(MultipartFile file) {
    if (file == null) {
  ...
  private Boolean isPermissionExt(String extension, String[] permissionExtensions) {
  ...
  private String putS3(MultipartFile file, String dirName) {
