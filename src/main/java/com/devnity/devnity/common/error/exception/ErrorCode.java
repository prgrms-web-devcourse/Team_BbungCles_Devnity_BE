...
public enum ErrorCode {
  ...
  GATHER_UPDATE_NOT_ALLOWED(403, "모집 게시글/댓글은 작성자만 수정할 수 있습니다."),
  GATHER_DELETE_NOT_ALLOWED(403, "모집 게시글/댓글은 작성자만 삭제할 수 있습니다."),
  CANNOT_UPDATE_CLOSED_GATHER(403, "마감된 모집은 수정할 수 없습니다."),
  INVALID_DEADLINE(400, "마감 날짜를 현재 날짜 이전으로 변경할 수 없습니다."),
